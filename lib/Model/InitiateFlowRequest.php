...
/**
 * InitiateFlowRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class InitiateFlowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiateFlowRequest';
    ...
    public function setDocIdField($doc_id_field)
    {
        ...
        if ((mb_strlen($doc_id_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $doc_id_field when calling InitiateFlowRequest., must be bigger than or equal to 1.');
        }
