...
/**
 * CancelFlowResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CancelFlowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelFlowResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling CancelFlowResponse., must be bigger than or equal to 1.');
        }
