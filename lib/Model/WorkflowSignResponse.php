...
/**
 * WorkflowSignResponse Class Doc Comment
 *
 * @category Class
 * @description #### This is the response returned when a user gets a request to sign a document workflow.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class WorkflowSignResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowSignResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling WorkflowSignResponse., must be bigger than or equal to 1.');
        }
