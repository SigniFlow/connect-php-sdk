...
/**
 * DownloadPortfolioResponse Class Doc Comment
 *
 * @category Class
 * @description #### The response returned when a user wants to download a portfolio.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DownloadPortfolioResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DownloadPortfolioResponse';
    ...
    protected static $attributeMap = [
        'portfolio_data_field' => 'PortfolioDataField',
    ...
    protected static $setters = [
        'portfolio_data_field' => 'setPortfolioDataField',
    ...
    protected static $getters = [
        'portfolio_data_field' => 'getPortfolioDataField',
    ...
    {
        $this->container['portfolio_data_field'] = $data['portfolio_data_field'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['portfolio_data_field'] === null) {
            $invalidProperties[] = "'portfolio_data_field' can't be null";
        }
        if ((mb_strlen($this->container['portfolio_data_field']) < 1)) {
            $invalidProperties[] = "invalid value for 'portfolio_data_field', the character length must be bigger than or equal to 1.";
        }
    ...
    /**
     * Gets portfolio_data_field
     *
     * @return string
     */
    public function getPortfolioDataField()
    {
        return $this->container['portfolio_data_field'];
    }

    /**
     * Sets portfolio_data_field
     *
     * @param string $portfolio_data_field Portfolio data field.
     *
     * @return self
     */
    public function setPortfolioDataField($portfolio_data_field)
    {

        if ((mb_strlen($portfolio_data_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $portfolio_data_field when calling DownloadPortfolioResponse., must be bigger than or equal to 1.');
        }

        $this->container['portfolio_data_field'] = $portfolio_data_field;
    ...
    public function setPortfolioNameField($portfolio_name_field)
    {
        ...
        if ((mb_strlen($portfolio_name_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $portfolio_name_field when calling DownloadPortfolioResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling DownloadPortfolioResponse., must be bigger than or equal to 1.');
        }
