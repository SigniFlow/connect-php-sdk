...
/**
 * GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField Class Doc Comment
 *
 * @category Class
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 ...
 */
class GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDocumentTagFieldPositionResponse_DocumentTagFieldsPositionField';
     ...
     *
     * @param string $x_coordinate_field The y coordinates of the field.
     *
     * @return self
     */
    public function setXCoordinateField($x_coordinate_field)
    {
        ...
        if ((mb_strlen($x_coordinate_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $x_coordinate_field when calling GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $y_coordinate_field The x coordinates of the field.
     *
     * @return self
     */
    public function setYCoordinateField($y_coordinate_field)
    {
        ...
        if ((mb_strlen($y_coordinate_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $y_coordinate_field when calling GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField., must be bigger than or equal to 1.');
        }
