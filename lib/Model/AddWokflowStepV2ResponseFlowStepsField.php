...
/**
 * AddWokflowStepV2ResponseFlowStepsField Class Doc Comment
 *
 * @category Class
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 ...
 */
class AddWokflowStepV2ResponseFlowStepsField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddWokflowStepV2Response_FlowStepsField';
     ...
     * Sets email_field
     *
     * @param string $email_field Participant email address field.
     *
     * @return self
     */
    public function setEmailField($email_field)
    {
        ...
        if ((mb_strlen($email_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email_field when calling AddWokflowStepV2ResponseFlowStepsField., must be bigger than or equal to 1.');
        }
