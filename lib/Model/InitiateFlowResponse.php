...
/**
 * InitiateFlowResponse Class Doc Comment
 *
 * @category Class
 * @description #### The response returned when a workflow is initiated.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InitiateFlowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiateFlowResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling InitiateFlowResponse., must be bigger than or equal to 1.');
        }
