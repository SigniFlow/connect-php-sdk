...
/**
 * DeleteDocResponse Class Doc Comment
 *
 * @category Class
 * @description #### This is the response that will be returned when a document is deleted.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DeleteDocResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteDocResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling DeleteDocResponse., must be bigger than or equal to 1.');
        }
