...
/**
 * TokenExtendResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class TokenExtendResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenExtendResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling TokenExtendResponse., must be bigger than or equal to 1.');
        }
