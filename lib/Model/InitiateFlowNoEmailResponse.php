...
/**
 * InitiateFlowNoEmailResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class InitiateFlowNoEmailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiateFlow_No_EmailResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling InitiateFlowNoEmailResponse., must be bigger than or equal to 1.');
        }
