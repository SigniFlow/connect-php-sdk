...
/**
 * GetAuditDocumentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetAuditDocumentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAuditDocumentRequest';
    ...
    public function setDocIdField($doc_id_field)
    {
        ...
        if ((mb_strlen($doc_id_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $doc_id_field when calling GetAuditDocumentRequest., must be bigger than or equal to 1.');
        }
