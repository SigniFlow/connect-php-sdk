...
/**
 * GetDocumentTagFieldPositionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetDocumentTagFieldPositionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDocumentTagFieldPositionRequest';
    ...
    public function setTagNameField($tag_name_field)
    {
        ...
        if ((mb_strlen($tag_name_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tag_name_field when calling GetDocumentTagFieldPositionRequest., must be bigger than or equal to 1.');
        }
