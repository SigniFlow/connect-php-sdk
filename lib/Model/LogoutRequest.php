 ...
 *
 * @category Class
 * @description #### The request sent when a user logs out.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class LogoutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['token_field']) < 1)) {
            $invalidProperties[] = "invalid value for 'token_field', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets token_field
     *
     * @param string $token_field token_field
     *
     * @return self
     */
    public function setTokenField($token_field)
    {
        ...
        if ((mb_strlen($token_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token_field when calling LogoutRequest., must be bigger than or equal to 1.');
        }
