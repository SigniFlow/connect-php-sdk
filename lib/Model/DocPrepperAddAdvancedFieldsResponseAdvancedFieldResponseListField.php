...
/**
 * DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField Class Doc Comment
 *
 * @category Class
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 ...
 */
class DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocPrepperAddAdvancedFieldsResponse_AdvancedFieldResponseListField';
     ...
     *
     * @param float $doc_field_id_field Document field ID.
     *
     * @return self
     */
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField., must be bigger than or equal to 1.');
        }
