...
/**
 * InitiateFlowNoInitialEmailRequest Class Doc Comment
 *
 * @category Class
 * @description #### The request sent to initiate a workflow skiiping the first email.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InitiateFlowNoInitialEmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiateFlow_No_Initial_EmailRequest';
    ...
    public function setDocIdField($doc_id_field)
    {
        ...
        if ((mb_strlen($doc_id_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $doc_id_field when calling InitiateFlowNoInitialEmailRequest., must be bigger than or equal to 1.');
        }
