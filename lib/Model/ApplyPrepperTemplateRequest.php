...
/**
 * ApplyPrepperTemplateRequest Class Doc Comment
 *
 * @category Class
 * @description #### Used to send a request for applying a template.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplyPrepperTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplyPrepperTemplateRequest';
     ...
     *
     * @param float $prepper_template_id_field Document prepper template ID field.
     *
     * @return self
     */
