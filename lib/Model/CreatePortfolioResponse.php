...
/**
 * CreatePortfolioResponse Class Doc Comment
 *
 * @category Class
 * @description #### The response received after a portfolio is created.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreatePortfolioResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePortfolioResponse';
     ...
     *
     * @param float $portfolio_id_field Document portfolio ID field.
     *
     * @return self
     */
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling CreatePortfolioResponse., must be bigger than or equal to 1.');
        }
