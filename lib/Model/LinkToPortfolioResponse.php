...
/**
 * LinkToPortfolioResponse Class Doc Comment
 *
 * @category Class
 * @description #### This is the response returned after requesting a url link to a portfolio.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LinkToPortfolioResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkToPortfolioResponse';
    ...
    public function setPortfolioIdField($portfolio_id_field)
    {
        ...
        if ((mb_strlen($portfolio_id_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $portfolio_id_field when calling LinkToPortfolioResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling LinkToPortfolioResponse., must be bigger than or equal to 1.');
        }
