...
/**
 * LogoutResponse Class Doc Comment
 *
 * @category Class
 * @description #### The response returned when a user logs out.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LogoutResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LogoutResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling LogoutResponse., must be bigger than or equal to 1.');
        }
