...
/**
 * FullWorkflowResponse Class Doc Comment
 *
 * @category Class
 * @description #### The response returned on FullWorkflow.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FullWorkflowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FullWorkflowResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status_field'] = $data['status_field'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['status_field'] === null) {
            $invalidProperties[] = "'status_field' can't be null";
        }
        if ((mb_strlen($this->container['status_field']) < 1)) {
            $invalidProperties[] = "invalid value for 'status_field', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setDocField($doc_field)
    {
        ...
        if ((mb_strlen($doc_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $doc_field when calling FullWorkflowResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float $portfolio_id_field portfolio_id_field
     *
     * @return self
     */
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling FullWorkflowResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['status_field'];
    }

    /**
     * Sets status_field
     *
     * @param string $status_field status_field
     *
     * @return self
     */
    public function setStatusField($status_field)
    {

        if ((mb_strlen($status_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status_field when calling FullWorkflowResponse., must be bigger than or equal to 1.');
        }

        $this->container['status_field'] = $status_field;
