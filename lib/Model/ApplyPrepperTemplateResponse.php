...
/**
 * ApplyPrepperTemplateResponse Class Doc Comment
 *
 * @category Class
 * @description #### Used to get the response afetr applying a template.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplyPrepperTemplateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplyPrepperTemplateResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling ApplyPrepperTemplateResponse., must be bigger than or equal to 1.');
        }
