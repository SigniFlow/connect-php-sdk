...
/**
 * SharePortfolioResponse Class Doc Comment
 *
 * @category Class
 * @description #### The response returned when a user wants to share a portfolio.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SharePortfolioResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SharePortfolioResponse';
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling SharePortfolioResponse., must be bigger than or equal to 1.');
        }
