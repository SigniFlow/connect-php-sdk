...
/**
 * InitiateFlowNoInitialEmailResponse Class Doc Comment
 *
 * @category Class
 * @description #### The response from requesting a workflow skipping the first email.
 * @package  SigniFlowConnect
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InitiateFlowNoInitialEmailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitiateFlow_No_Initial_EmailResponse';
     ...
     * Sets doc_id_field
     *
     * @param float $doc_id_field The document ID.
     *
     * @return self
     */
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling InitiateFlowNoInitialEmailResponse., must be bigger than or equal to 1.');
        }
