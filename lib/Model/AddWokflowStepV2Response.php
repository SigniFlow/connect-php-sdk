...
/**
 * AddWokflowStepV2Response Class Doc Comment
 *
 * @category Class
 ...
 */
class AddWokflowStepV2Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddWokflowStepV2Response';
    ...
    protected static $openAPITypes = [
        'doc_id_field' => 'float',
        'flow_id_field' => 'float',
        'flow_steps_field' => '\SigniFlowConnect\Model\AddWokflowStepV2ResponseFlowStepsField[]',
        'result_field' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'flow_steps_field' => 'FlowStepsField',
    ...
    protected static $setters = [
        ...
        'flow_steps_field' => 'setFlowStepsField',
    ...
    protected static $getters = [
        ...
        'flow_steps_field' => 'getFlowStepsField',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['flow_steps_field'] = $data['flow_steps_field'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flow_steps_field'] === null) {
            $invalidProperties[] = "'flow_steps_field' can't be null";
        }
        if ((count($this->container['flow_steps_field']) < 1)) {
            $invalidProperties[] = "invalid value for 'flow_steps_field', number of items must be greater than or equal to 1.";
        }
    ...
    /**
     * Gets flow_steps_field
     *
     * @return \SigniFlowConnect\Model\AddWokflowStepV2ResponseFlowStepsField[]
     */
    public function getFlowStepsField()
    {
        return $this->container['flow_steps_field'];
    }

    /**
     * Sets flow_steps_field
     *
     * @param \SigniFlowConnect\Model\AddWokflowStepV2ResponseFlowStepsField[] $flow_steps_field flow_steps_field
     *
     * @return self
     */
    public function setFlowStepsField($flow_steps_field)
    {


        if ((count($flow_steps_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $flow_steps_field when calling AddWokflowStepV2Response., number of items must be greater than or equal to 1.');
        }
        $this->container['flow_steps_field'] = $flow_steps_field;
    ...
    public function setResultField($result_field)
    {
        ...
        if ((mb_strlen($result_field) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result_field when calling AddWokflowStepV2Response., must be bigger than or equal to 1.');
        }
